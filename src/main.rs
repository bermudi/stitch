...
#[derive(Serialize)]
pub(crate) struct ImportedStore {
    store: String,
    target: String,
    mode: String,
    #[serde(skip_serializing_if = "Vec::is_empty")]
...
mod tests {
    ...
    fn migrate_rejects_invalid_store_name_before_writes() {
        ...
        let err = crate::commands::migrate::cmd_migrate(repo, false, false).unwrap_err();
        assert_eq!(err.exit_code(), 9);
...
"#,
        ...
        crate::commands::remove::cmd_remove(repo, "app", false, false).unwrap();
